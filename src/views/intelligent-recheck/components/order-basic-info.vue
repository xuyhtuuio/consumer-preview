...
export default {
  ...
  methods: {
    init() {
      const keys = Object.keys(this.params) || Object.keys(this.sidebarParam)
    ...
    getOrderDetail() {
      ...
      getApplyForm({
        formCategoryId:
          (this.params && this.params.formManagementId) || (this.sidebarParam && this.sidebarParam.formManagementId),
        formId: this.params.formId || this.sidebarParam.formId,
        processTemplateId: this.params.processTemplateId,
