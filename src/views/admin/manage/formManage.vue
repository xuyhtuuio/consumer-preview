    ...
    <div v-loading="loadingList" style="height: calc(100% - 63px); overflow-y: auto;">
      ...
      <div v-else>
        <div style="margin-bottom: 24px;">
          ...
          <el-button type="primary" @click="addFormItem" size="small" style="margin-left: 16px;" v-if="!isView" :disabled="isView">新增字段</el-button>
        </div>
...
export default {
  ...
  computed: {
    editAuth() {
      ...
      const flowManage = permissionsPage.funPerms.find(item => item.code === 'formManagement') || {}
