 ...
 * @LastEditTime: 2023-10-26 13:51:30
  ...
  <div class="laws" v-loading="search.loading">
    ...
    >
      <el-form :model="form" :rules="rules" ref="form">
        ...
        <el-form-item label="拟稿部门" prop="unit">
          <el-input v-model="form.unit" clearable placeholder="请输入拟稿部门">
          </el-input>
          <div class="error-tip">
            <el-popover
              placement="top"
              trigger="hover"
              content="拟稿部门最多可输入50字"
