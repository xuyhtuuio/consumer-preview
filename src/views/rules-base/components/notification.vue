  ...
  <div class="laws" v-loading="search.loading">
        ...
        <div class="cards pointer">
          ...
          <div class="file-info">
            ...
            <div class="detail">
              <div class="file-unit">
                <span
                  >文件来源：<i>{{ wordEllipsis(item.unit, 20) }}</i></span
                >
    ...
    >
      <el-form :model="form" :rules="rules" ref="form">
        ...
        <el-form-item label="文件来源" prop="unit">
          <el-input v-model="form.unit" clearable placeholder="请输入文件来源">
          </el-input>
          <div class="error-tip">
            <el-popover
              placement="top"
              trigger="hover"
              content="文件来源最多可输入50字"
