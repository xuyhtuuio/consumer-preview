<template>
  ...
  <el-dialog
    ...
    <div class="textarea">
      ...
      <el-input v-char v-model.trim="content" @focus="handleFocus" @blur="handleBlur" type="textarea" placeholder="有什么新的案例分享给大家？" :rows="6" :maxlength="500" :minlength="1"></el-input>
    </div>
